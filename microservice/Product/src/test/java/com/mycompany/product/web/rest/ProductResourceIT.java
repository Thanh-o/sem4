...
import static com.mycompany.product.domain.ProductAsserts.*;
import static com.mycompany.product.web.rest.TestUtil.createUpdateProxyForBean;
import static com.mycompany.product.web.rest.TestUtil.sameNumber;
...
import com.mycompany.product.IntegrationTest;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE).description(DEFAULT_DESCRIPTION).category(DEFAULT_CATEGORY);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION).category(UPDATED_CATEGORY);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION).category(UPDATED_CATEGORY);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION).category(UPDATED_CATEGORY);
