...
Call log:
  - waiting for locator('[data-testid="view-product-1"]')
    - locator resolved to <button data-testid="view-product-1" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full">Xem chi tiết</button>
  - attempting click action
    ...
    at PlaywrightTestRunner.executeStep (C:\Boss\GitHub\sem4\2level\test-logic\ecommerce-with-tests\tests\playwright\ecommerce.spec.js:17:25)
...
- main:
  ...
  - paragraph: Khám phá những sản phẩm công nghệ mới nhất
  - img "iPhone 15 Pro"
  - text: iPhone 15 Pro Điện thoại
  - paragraph: iPhone 15 Pro với chip A17 Pro mạnh mẽ
  - paragraph: $999
  - link "Xem chi tiết":
    - /url: /product/1
    - button "Xem chi tiết"
  - button "Thêm vào giỏ"
  - img "MacBook Air M2"
  - text: MacBook Air M2 Laptop
  - paragraph: MacBook Air với chip M2 siêu mỏng nhẹ
  - paragraph: $1199
  - link "Xem chi tiết":
    - /url: /product/2
    - button "Xem chi tiết"
  - button "Thêm vào giỏ"
  - img "AirPods Pro"
  - text: AirPods Pro Phụ kiện
  - paragraph: AirPods Pro với chống ồn chủ động
  - paragraph: $249
  - link "Xem chi tiết":
    - /url: /product/3
    - button "Xem chi tiết"
  ...
  - paragraph: iPad Pro với màn hình Liquid Retina
  - paragraph: $799
  - link "Xem chi tiết":
    - /url: /product/4
    - button "Xem chi tiết"
