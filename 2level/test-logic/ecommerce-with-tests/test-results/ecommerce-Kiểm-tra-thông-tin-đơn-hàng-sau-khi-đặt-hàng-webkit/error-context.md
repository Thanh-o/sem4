...
- main:
  ...
  - textbox "Email *": customer@test.com
  - text: Địa chỉ giao hàng Họ *
  - textbox "Họ *": Tran
  - text: Tên *
  - textbox "Tên *": Thi B
  - text: Địa chỉ *
  - textbox "Địa chỉ *": 456 Le Loi
  - text: Thành phố *
  - textbox "Thành phố *": Ha Noi
  - text: Mã bưu điện *
  - textbox "Mã bưu điện *": "10000"
  - text: Số điện thoại *
  - textbox "Số điện thoại *": "0987654321"
  - text: Phương thức thanh toán
  - combobox: Chọn phương thức thanh toán
  - text: "Đơn hàng của bạn iPad Prox1 $799 Tạm tính: $799 Phí vận chuyển: Miễn phí Tổng cộng: $799"
  - button "Đặt hàng"
```
