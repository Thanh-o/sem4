...
To build the final jar and optimize the jhipsfullapp application for production, run:
...
Then navigate to [http://localhost:9191](http://localhost:9191) in your browser.
